                ...
                <div id="login-column" class="col-md-6">
                    <div id="login-box" class="col-md-12">
                        <form id="login-form" class="form" action="Assignment/Call" method="post">
                            <h3 class="text-center text-info">Change info</h3>
                            <div class="form-group">
                                <label  class="text-info">Username:</label><br>
                                <input type="text" name="idUser" id="idUser" class="form-control"  value="${user.idUser}">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <input type="submit" name="submit" class="btn btn-info btn-md" formaction="<%=request.getContextPath()%>/Call/changeUser" value="Update">
                            </div>
                        </form>
                    </div>
                </div>
